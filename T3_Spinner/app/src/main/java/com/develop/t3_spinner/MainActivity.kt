...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    private fun acciones() {
        ...
        binding.botonAgregar.setOnClickListener {
            ...
            var paisComplejo: Pais = binding.spinnerComplejo.selectedItem as Pais;
            Log.v("testSpinner", paisComplejo.nombre)
            binding.imageViewResultado.setImageResource(paisComplejo.imagen)
        }
    }
    ...
    private fun rellenarSpinnerPersonalizado() {
        ...
        arraySpinner.add(Pais("Argentina", R.drawable.argentina))
        adaptadorPersonalizado.notifyDataSetChanged()
